...
<head>
    ...
    <link rel="stylesheet" href="/pop-it-mvc/views/layouts/style.css" type="text/css">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" <a href="<?= app()->route->getUrl('/hello') ?>">Главная</a><span class="sr-only"></span></a>
                </li>
                <?php
                if (!app()->auth::check()):?>
                <li class="nav-item">
